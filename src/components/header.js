...
const API_ADRESS = 'https://spotify-api-wrapper.appspot.com';
 class Header extends Component{
        ...
        artistQuaryonChange = (event) =>{
           
            this.setState({
                artistQuary:event.target.value,
            })
        }

        searchArtist =() => {
             fetch(`${API_ADRESS}/artist/${this.state.artistQuary}`)
     ...
     render(){
         ...
         return(
                ...
                <div className="app-container">
                    <div id="header" className="header d-flex flex-column flex-wrap align-items-center">
                        ...
                        <div className="container text-center d-flex flex-column align-items-center">
                            ...
                            <h1>Music Master</h1>
                            <div>
                                    <input  onKeyPress={this.onKeyPressHandler} style={{width:200}} onChange={this.artistQuaryonChange}  className="form-control mr-sm-2" type="search" placeholder="search your artist" aria-label=""/>
                                
                                
                                    <a href="#artist" className="btn"
                 ...
                 <div id ="artist">
                            ...
                            {/* <div>
                            <a className=" sticky-search sticky-top" href="#header">search</a>
                            </div> */}
